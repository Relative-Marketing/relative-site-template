...
noroot ssh relative@31.193.3.183.srvlist.ukfast.net `whoami; wp db export --path="${WP_PATH}" vvv-db-backup.sql; tar -jcvf test-delete.tar.gz vvv-db-backup.sql; exit;` -P 2020
