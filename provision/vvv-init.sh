...
ssh relative@31.193.3.183.srvlist.ukfast.net 'wp db export --path="public_html" vvv-db-backup.sql; tar -jcvf test-delete.tar.gz vvv-bd-backup.sql; exit;' -P 2020
